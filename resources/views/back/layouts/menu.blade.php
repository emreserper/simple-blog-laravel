...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text">The North Admin</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse @if(Request::segment(2)=="articles") show @endif"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item @if(Request::segment(2)=="articles" and !Request::segment(3)) active @endif"
                       href="{{route('admin.articles.index')}}">All Articles</a>
                    <a class="collapse-item @if(Request::segment(2)=="articles" and Request::segment(3)=="create") active @endif"
                       href="{{route('admin.articles.create')}}">Create Article</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePage" class="collapse @if(Request::segment(2)=="pages") show @endif"
                 aria-labelledby="headingPage" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Page Operations:</h6>
                    <a class="collapse-item @if(Request::segment(2)=="pages" and !Request::segment(3)) active @endif"
                       href="{{route('admin.page.index')}}">All Pages</a>
                    <a class="collapse-item @if(Request::segment(2)=="pages" and Request::segment(3)=="create") active @endif"
                       href="{{route('admin.page.create')}}">Create Page</a>
                </div>
            </div>
        </li>
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="{{route('homepage')}}" target="_blank"
                       class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            class="fas fa-globe fa-sm text-white-50"></i> View Site</a>
                </div>
